                                        ...
                                        <v-col cols="12" sm="4" md="4" mr-1>
                                            <div class="selectdiv form-group pt-1">
                                                ...
                                                <select 
                                                    ...
                                                    <option :value="num.value" v-for="(num, index) in cardRoleItems" :key="index">
                                                        <span>{{ num.text }}</span>
                                                ...
                                                <!--                                                
                                                <vue-select
                                                class="style-chooser mt-3 pt-1"
                                                    :options="cardRoleItems"
                                                    :value="selectText"
                                                    label="text" 
                                                ></vue-select>
                                                -->
...
export default {
    ...
    methods: {
        ...
        save () {
            this.editedItem.roleName = this.cardRoleItems[this.selectValue-1].text;
        ...
        //    this.selectValue = value;
            console.log("select event.target.value...", this.selectValue);
            //let temp = event.target.options[event.target.selectedIndex].childNodes[0]; 
            //let temp = event.target.options[event.target.selectedIndex].children().css({"color": "red"});            
            //let temp = event.target.options[event.target.selectedIndex].children[0];            
            //event.target.options[event.target.selectedIndex].children[0].css({"color": "red"});            
            let children = event.target.options[event.target.selectedIndex].querySelectorAll('span'); 
            var chip1_styles = {
            ...
            //Object.assign(children[0].style, chip1_styles);
            children[0].setAttribute('class', 'chip_style');
            //console.log("select target...", temp);
            console.log("children...", children);
            //console.log("select target childNodes...", event.target.options[event.target.selectedIndex].children[0]);

            //event.target.options[event.target.selectedIndex].childNodes[0].style.color = 'red';
