...
@section('content')
<!-- BANNER -->
<div class="blog_banner" style="background: url('{{ asset('front/banner.jpg') }}'); background-size: cover;">
									...
									<div class="post_author_sec">
										<div class="post_author_left">
											<div class="post_author_img">
												<img src="{{ asset('front/banner.jpg') }}" alt="image">
											</div>
							...
							<div class="post_dtls_cmnt_sec mar_t20">
									...
									<div class="cmnt_box_top dis_flx">
										<div class="cmnt_box_top_left d-flex">
											<div class="cmnt_img mar_r15">
												<img src="{{ asset('front/img/girl-cmnt.jpg') }}" alt="image">
											</div>
								...
								<div class="cmnt_box_all reply_sec">
									<div class="cmnt_box_top dis_flx">
										<div class="cmnt_box_top_left d-flex">
											<div class="cmnt_img mar_r15">
												<img src="{{ asset('front/img/girl2-cmnt.jpg') }}" alt="image">
											</div>
											<div class="cmnnt_name">
								...
								<div class="cmnt_box_all reply_sec">
									<div class="cmnt_box_top d-flex">
										<div class="cmnt_box_top_left d-flex">
											<div class="cmnt_img mar_r15">
												<img src="{{ asset('front/img/girl3-cmnt.jpg') }}" alt="image">
											</div>
											<div class="cmnnt_name">
												<div class="cmnt_name_left dis_fx_cntr">
								...
								<div class="cmnt_box_all">
									<div class="cmnt_box_top dis_flx">
										<div class="cmnt_box_top_left d-flex">
											<div class="cmnt_img mar_r15">
												<img src="{{ asset('front/img/girl4-cmnt.jpg') }}" alt="image">
											</div>
											<div class="cmnnt_name">
												<div class="cmnt_name_left">
									...
									@foreach ($relatedBlogs as $b)
										<div class="blog_post_r8_item">
											...
											<div class="blog_post_item_r8">
												<a href="{{ route('blog_slug', $b->slug) }}">
													<h4 class="blog_post_item_r8_h4">
														{{ $b->title }}
													</h4>
												</a>
												<a href=""><p class="author_name2">-{{ $b->user->name }}</p></a>
											</div>
										</div>
									@endforeach
								@endif
								...
								<ul class="post_tags_ul">
                                    @if (count($blog->tags) > 0)
                                        @foreach ($blog->tags as $t)
                                            <li>
                                                <a href="{{ route('blog_tag', ['tagName' => $t->tagName, 'id' =>$t->id]) }}">{{ $t->tagName }}</a>
                                            </li>
                                        @endforeach
                                    @endif
								</ul>
